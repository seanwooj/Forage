...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header>
		<hgroup>
			<h2 class="section-header"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'foundation' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
